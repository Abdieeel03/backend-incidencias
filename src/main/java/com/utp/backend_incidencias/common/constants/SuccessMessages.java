...
public class SuccessMessages {
    ...
    public static final String USERS_RETRIEVED =
    ...
    public static final String CLASSES_RETRIEVED =
            "Clases obtenidas correctamente";

    public static final String CLASS_RETRIEVED =
            "Clase obtenida correctamente";

    public static final String CLASS_UPDATED =
    ...
    public static final String INCIDENTS_RETRIEVED =
            "Incidentes obtenidos correctamente";

    public static final String INCIDENT_RETRIEVED =
            "Incidente obtenido correctamente";

    public static final String INCIDENT_UPDATED =
            "Incidente actualizado correctamente";

    public static final String INCIDENT_DELETED =
